lane_cfg = {
    ...
    "model": "ocrnet",
    "to_rgb":True,
    "savd_dir": "saved_model/ocrnet_960_1080/",
    "pretrained": "pretrained_model/ocnet_w18_bn_cityscapes/",
    "infer_model": "saved_model/ocrnet_960_1080/12/",
    "result_dir": "result/ocrnet_960_1080/",

    #数据集
    "data_dir":"dataset/",
    "train_list":"dataset/train_list_C_expand_v3.txt",
